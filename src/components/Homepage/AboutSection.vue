  ...
  <section class="about">
    ...
    <div class="about__text">
      <h2 class="about__text__heading">
        The best <span>footwear</span> ever
      </h2>
      <p class="about__text__description">
        Located in London, Shoe-Shop is the premier store
        for high end shoes. We
        have a large showroom and luxury demonstration rooms available for you
        to browse and experience a wide range of our products. Stop by our store
        to meet some of the fantastic people who make Shoe-Shop the best place
